""" 
some concepts u came to know
input function creates user input to a string by itself 
we can acceses the string by using the variable name and this print(x.[whichever no yoou enter])
